...
Type type, IDataReader reader, int startBound = 0, int length = -1, bool returnNullIfFirstMissing = false
...
)
        {
            ...
            // modified by ZQS, Replace("_","") to suite the column name in the database
            var names = Enumerable.Range(startBound, length).Select(i => reader.GetName(i).Replace("_","")).ToArray();
